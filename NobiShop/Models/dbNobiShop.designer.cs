...
namespace NobiShop.Models
{
	...
	[global::System.Data.Linq.Mapping.DatabaseAttribute(Name="NOBISHOP")]
	public partial class dbNobiShopDataContext : System.Data.Linq.DataContext
	{
    ...
    partial void DeleteLOAI(LOAI instance);
		...
		public dbNobiShopDataContext() : 
				base(global::System.Configuration.ConfigurationManager.ConnectionStrings["NOBISHOPConnectionString"].ConnectionString, mappingSource)
		{
			OnCreated();
		}
		
		public dbNobiShopDataContext(string connection) : 
				base(connection, mappingSource)
		{
			OnCreated();
		}
		
		public dbNobiShopDataContext(System.Data.IDbConnection connection) : 
				base(connection, mappingSource)
		{
			OnCreated();
		}
		
		public dbNobiShopDataContext(string connection, System.Data.Linq.Mapping.MappingSource mappingSource) : 
				base(connection, mappingSource)
		{
			OnCreated();
		}
		
		public dbNobiShopDataContext(System.Data.IDbConnection connection, System.Data.Linq.Mapping.MappingSource mappingSource) : 
				base(connection, mappingSource)
		{
			OnCreated();
		}
    ...
    partial void OnMaDVChanged();
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="DICHVU_SANPHAM", Storage="_DICHVU", ThisKey="MaDV", OtherKey="MaDV", IsForeignKey=true)]
    ...
    partial void OnTenDVChanged();
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="DICHVU_SANPHAM", Storage="_SANPHAMs", ThisKey="MaDV", OtherKey="MaDV")]
    ...
    partial void OnMaLoaiChanged();
    partial void OnTenLoaiChoChanging(string value);
    partial void OnTenLoaiChoChanged();
    #endregion
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_TenLoaiCho", DbType="NVarChar(50) NOT NULL", CanBeNull=false)]
		public string TenLoaiCho
		{
			get
			{
				return this._TenLoaiCho;
			}
			set
			{
				if ((this._TenLoaiCho != value))
				{
					this.OnTenLoaiChoChanging(value);
					this.SendPropertyChanging();
					this._TenLoaiCho = value;
					this.SendPropertyChanged("TenLoaiCho");
					this.OnTenLoaiChoChanged();
				}
			}
		}
